...
<body>
	...
	<div class="header">
		...
		<div class="main">
			<div class="box-top">
				<img src="./userinfo_files/yilogo.jpg"> <span class="tit"><a
					href="">白杨会员</a></span> <span class="btn btn-outline-secondary exit"
					style="padding: 0 20px 13px 20px"><a href="">返回首页</a></span>
			</div>
			...
			<div class="box-main">
				...
				<div class="update-photo">
					<div class="tx">
						<img alt="" src="./userinfo_files/touxiang.jpg" width="100px"
							height="100px">
					</div>
				...
				<div class="userinfo">
					<div class="tit">
						...
						<a href="" data-toggle="modal" data-target="#myModal"
							class="btn btn-outline-secondary bj"
							style="padding: 0 20px 13px 20px; height: 28px"> <i>编辑资料</i></a>
						<!-- <a href="" data-toggle="modal" data-target="#myModal"
					...
					<div class="jbxx">
						<div class="hang">
							<i class="y"></i> <a class="x"></a>
						</div>
						<div class="hang">
							<i class="y">昵称:</i> <a class="x">${customer.customerName}</a>
						</div>
						<div class="hang">
							<i class="y">性别:</i> <a class="x">${customer.gendar}</a>
						</div>
						<div class="hang">
							<i class="y">年龄:</i> <a class="x">${customer.age}</a>
						</div>
						<div class="hang">
							<i class="y">电话:</i> <a class="x">${customer.phone}</a>
						</div>
						<div class="hang">
							<i class="y">地址:</i> <a class="x">${customer.address}</a>
						</div>
						<div class="hang">
							<i class="y">密码:</i> <a class="x">******</a>
						</div>
						<div class="hang">
							<i class="y">Email:</i> <a class="x">${customer.email}</a>
						</div>
					</div>
				</div>

				<div class="gjuserinfo"></div>
			</div>
		</div>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<form class="form-horizontal" role="form"
				action="${pageContext.request.contextPath }/customerServlet?cmd=changeInfor"
				method="post">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="hidden" class="form-control"
									name="id" value="${customer.customerId}" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.customerName}" value="${customer.customerName}" name="name" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.gendar}" value="${customer.gendar}" name="gendar" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.password}" value="${customer.password}" name="password" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.age}" value="${customer.age}" name="age" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.phone}" value="${customer.phone}" name="phone" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.address}" value="${customer.address}" name="address" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control"
									placeholder="${customer.email}" value="${customer.email}" name="email" />
							</div>
						</div>
					</div>
